...
RSpec.describe Forms::SubmissionAttachmentsInput, type: :model do
  describe "validation" do
    ...
    context "when given a valid submission format" do
    ...
    context "when given an invalid submission format" do
      ...
      it "returns a validation error" do
        ...
        expect(submission_attachments_input.errors.full_messages_for(:base)).to include("Choose if you want to get completed forms as CSV or JSON files")
      end
    end
    ...
    context "when not given a submission format" do
      it "returns a validation error" do
        ...
        expect(submission_attachments_input.errors.full_messages_for(:submission_format)).to include("Submission format Choose if you want to get completed forms as CSV or JSON files")
      end
    end
  end
